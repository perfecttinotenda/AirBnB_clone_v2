...
class TestReview(unittest.TestCase):
    """
        Will be testing Review class
    """

    def test_Review_inheritance(self):
        """
            Will tests if Review class Inherits from BaseModel
        """
        new_review = Review()
    ...
    def test_Review_attributes(self):
        """
            Will test tif Review class has place_id, user_id and text attr
        """
        new_review = Review()
    ...
    def test_Review_attributes(self):
        """
            Will test if Review class has place_id, user_id & text attr.
        """
        new_review = Review()
